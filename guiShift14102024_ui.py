...
################################################################################
## Form generated from reading UI file 'guiShift14102024.ui'
##
...
class Ui_GridEyeTerminal(object):
    def setupUi(self, GridEyeTerminal):
        ...
        sizePolicy3.setHeightForWidth(self.frame_1.sizePolicy().hasHeightForWidth())
        self.frame_1.setSizePolicy(sizePolicy3)
        ...
        sizePolicy3.setHeightForWidth(self.frameFinal.sizePolicy().hasHeightForWidth())
        self.frameFinal.setSizePolicy(sizePolicy3)
